...
namespace Biosite.Domain.ExamName.Entities
{
    public class Exam
    {
        ...
        public Exam(int examCode, string examName, string examUnit, decimal biologicalValue, decimal referenceMinValue, decimal referenceMaxValue, bool useQuartil)
        {
